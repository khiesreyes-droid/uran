...
function AuthInput({ icon, error, testID, c, rightElement, ...props }: AuthInputProps) {
...
export function SignUpForm({ onSubmit = () => {}, onLogin, onGoogleSignIn, googleLoading = false }: SignUpFormProps) {
  ...
  return (
    <View style={[s.root, { backgroundColor: c.background }]}>
      {/* Decorative orbs */}
      <View style={[s.orbTopLeft, { backgroundColor: orbPrimary }]} />
      <View style={[s.orbBottomRight, { backgroundColor: orbTertiary }]} />
      ...
      <KeyboardAvoidingView style={s.kav} behavior="padding" keyboardVerticalOffset={10}>
        ...
        >
          ...
          <View style={[s.card, { backgroundColor: cardBg, borderColor: cardBorder }]}>
            <Text style={[s.cardTitle, { color: c.onSurface }]}>Create Account</Text>
            <Text style={[s.cardSub, { color: c.onSurfaceVariant }]}>
              Secure your garments with smart protection.
            </Text>
            ...
            <View style={s.fieldGroup}>
              ...
              <form.Field
                ...
                children={field => (
                  <AuthInput
                    testID="name-input"
                    icon={<PersonIcon color={c.outline} />}
                    c={c}
                ...
                children={field => (
                  <AuthInput
                    ...
                    rightElement={
                      ...
                      >
                        {showPassword
                          ? <EyeOffIcon color={c.onSurfaceVariant} />
                          : <EyeIcon color={c.onSurfaceVariant} />}
                      </Pressable>
                    }
                  />
                )}
            ...
            <form.Subscribe
              ...
              children={([isSubmitting]) => (
                ...
                >
                  <Text style={[s.submitBtnText, { color: c.onPrimaryContainer }]}>
          ...
          <View style={s.footer}>
            <View style={s.loginRow}>
              ...
              <Pressable onPress={onLogin}>
                <Text style={[s.loginLink, { color: c.primary }]}>Log In</Text>
              </Pressable>
            </View>
          </View>
        </ScrollView>
...
const s = StyleSheet.create({
  ...
  submitBtnText: { fontSize: 16, fontWeight: '700', letterSpacing: 0.5 },
